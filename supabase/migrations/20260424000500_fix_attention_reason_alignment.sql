    ...
    select
      ...
      case
        ...
        when derived.has_upcoming_event
          or derived.has_fresh_event then 'atencion_visible'
      ...
      case
        ...
        when derived.has_source_issue or derived.requires_manual_review or derived.has_not_found then 'elevada_por_riesgo'
