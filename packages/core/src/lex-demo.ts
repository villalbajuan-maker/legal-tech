...
export const lexDemoRows: LexDemoProcessRow[] = [
  ...
  },
  {
    ...
    annotation: "Movimiento detectado con posible término. Requiere lectura del responsable antes del cierre.",
    date: "Ayer, 15:05",
    minutesAgo: 1495,
    owner: "Carlos M.",
    priority: "Alta",
  ...
  },
  {
    ...
    annotation: "Actuación con posible impacto operativo. Requiere validación del responsable.",
    date: "Hace 6 días",
    minutesAgo: 8760,
    owner: "Laura P.",
    priority: "Alta",
  ...
  {
    radicado: "11001418901820230049400",
    status: "Sin cambios",
    statusType: "sin-cambios",
    action: "Auto admite demanda",
    annotation: "La consulta más reciente no mostró variaciones frente al último snapshot confiable.",
    date: "Hoy, 09:05",
    minutesAgo: 73,
    owner: "Ana R.",
    priority: "Media",
  ...
  {
    radicado: "11001400300720220073100",
    status: "Sin cambios",
    statusType: "sin-cambios",
    action: "Fijación en estado",
    annotation: "No se detectaron cambios operativos desde la consulta anterior.",
    date: "Hace 7 días",
    minutesAgo: 10080,
    owner: "Carlos M.",
    priority: "Baja",
