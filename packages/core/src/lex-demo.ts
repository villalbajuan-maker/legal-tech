...
const lexDemoSeedRows: LexDemoSeedRow[] = [
  ...
  seed("110014003077", 2022, 730, "sin-cambios", "Actuacion administrativa", "Constancia secretarial", "La consulta reciente no mostró cambios frente al último snapshot confiable.", 4380, "Laura P.", "Media"),
  ...
  seed("110014003025", 2023, 640, "sin-cambios", "Actuacion administrativa", "Ingreso al despacho", "Se mantiene el mismo estado operativo observado en la consulta anterior.", 250, "Carlos M.", "Alta"),
  seed("110014003007", 2024, 117, "sin-cambios", "Documento / memorial", "Memorial allegado", "La consulta no mostró actuaciones posteriores al memorial ya registrado.", 340, "Paula G.", "Media"),
  ...
  seed("110013103004", 2025, 77, "sin-cambios", "Medida cautelar", "Solicitud de medida cautelar", "No se detectaron actuaciones nuevas posteriores a la solicitud registrada.", 215, "Ana R.", "Alta"),
